...
from .bases_aug import ImageDataset, TextDataset, ImageTextDataset, ImageTextMLMDataset
...
from .rsitmd import RSITMD
from .ucm import UCM
from .sydney import Sydney

__factory = {'cuhk_peds': CUHKPEDES, 'icfg_peds': ICFGPEDES, 'rstp_reid': RSTPReid,
             'f30k': FLICKR30K, 'coco': COCO, 'rsicd': RSICD, 'rsitmd': RSITMD, 'ucm': UCM, 'sydney': Sydney}
...
def build_dataloader(args, tranforms=None):
	...
	if args.training:
		...
		if args.MLM:
			train_set = ImageTextMLMDataset(dataset.train, dataset.parsed_cap,
			                                train_transforms,
